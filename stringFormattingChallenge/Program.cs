...
comparisonMessage = currentProduct.PadRight(11);
comparisonMessage += $"{currentReturn:P2}".PadLeft(16);
comparisonMessage += $"{currentProfit:C}".PadLeft(17);

string comparisonMessage2 = "";

comparisonMessage2 = newProduct.PadRight(11);
comparisonMessage2 += $"{newReturn:P2}".PadLeft(12);
comparisonMessage2 += $"{newProfit:C}".PadLeft(17);
